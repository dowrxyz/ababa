...
Route::post('update-password-socio', [SocioController::class, 'updatePassword']);
...
Route::get('get-aportes-socios-app/', [AportesSocioController::class, 'getAportesApp']);
...
Route::get('procesos-socio-app/', [ProcesoSocioController::class, 'procesosSocioApp']);
...
Route::get('getSocioHistorico/{socio}', [HistoricoController::class, 'get_socio']);
