...
class Socio extends Authenticatable
{
  ...
  {
    if ($value == 1) {
      return $this->attributes["mies"] = true;
    } else {
      return $this->attributes["mies"] = false;
    }
  }
  ...
  {
    if ($value == 1) {
      return $this->attributes["mt"] = true;
    } else {
      return $this->attributes["mt"] = false;
    }
  }
}
