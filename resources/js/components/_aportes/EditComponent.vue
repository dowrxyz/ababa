            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
              ...
              <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false" v-on:submit.prevent="updateRegistro()">
                ...
                <div class="col-12 col-md-6">
                  <label class="form-label" for="modalEditUserFirstName">Aporte</label>
                  <input type="number" class="form-control" placeholder="" v-model="editando.aporte" />
                </div>
                <div class="col-12 col-md-6">
                  <label class="form-label" for="modalEditUserStatus">Año</label>
                  <select id="modalEditUserStatus" name="modalEditUserStatus" v-model="editando.ano" class="form-select" aria-label="Default select example" >
                ...
                <div class="col-12 col-md-6">
                  <label class="form-label" for="modalEditUserStatus">Tipo de Aporte</label>
                  <select id="modalEditUserStatus" name="modalEditUserStatus" v-model="editando.tipo_aporte" class="form-select" aria-label="Default select example" >
    ...
    export default {
        ...
        methods: {
            updateRegistro()
            {
                ...
                axios.put('/api/aportes', params).then((response) => {
