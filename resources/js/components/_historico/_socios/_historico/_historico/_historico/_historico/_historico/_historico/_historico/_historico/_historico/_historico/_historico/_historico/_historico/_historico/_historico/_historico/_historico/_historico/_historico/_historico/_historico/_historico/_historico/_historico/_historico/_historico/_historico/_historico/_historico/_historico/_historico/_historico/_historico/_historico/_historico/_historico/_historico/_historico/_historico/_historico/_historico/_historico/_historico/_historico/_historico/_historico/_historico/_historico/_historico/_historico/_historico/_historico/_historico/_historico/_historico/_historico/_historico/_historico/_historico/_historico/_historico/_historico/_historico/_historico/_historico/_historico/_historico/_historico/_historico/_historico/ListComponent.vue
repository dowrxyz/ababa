<template>
    ...
    <el-row style="margin-left: 20px; margin-right:20px;" :gutter="10">
        ...
        <el-col :span="4">
          <el-select class="w-100" v-model="pago" placeholder="Tipo de pago" @change="Search()">
              <el-option
                  v-for="item in pagos"
                  :key="item.id"
                  :label="item.nombre"
        ...
        <el-table-column type="expand">
            <template slot-scope="props">
                <el-row style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px;" :gutter="20">
                    ...
                    <el-col :span="4">
                      <el-button style="width: 100%" type="primary" @click="dsecargarArchivo(props.row.documento_pdf.url)"> <i class="fa fa-file-pdf"></i> Documento</el-button>
                    </el-col>
                    <el-col :span="4">
                    ...
                    <el-col :span="5" style="margin-top: 10px;">
                        <el-button style="width: 100%" type="primary" @click="dsecargarDocumento('/documentos_descarga/FORMULARIO ACTUALIZCION DE DATOS- MARZO 2022.docx')"> <i class="fa fa-file-pdf"></i> Actualización De Datos</el-button>
                    </el-col>
                    <el-col :span="4" style="margin-top: 10px;">
                        <el-button style="width: 100%" type="primary" @click="dsecargarDocumento('/documentos_descarga/FORMULARIOS   PARA DESCUENTOS ISSFA SOCIOS NUEVA VISION.docx')"> <i class="fa fa-file-pdf"></i> Descuento Del ISSFA</el-button>
                    </el-col>
                </el-row>
