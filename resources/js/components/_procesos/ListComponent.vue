<template>
  <div class="card">
    <div class="card-header">
      ...
      <button class="btn btn-success text-right" @click="crear">
        <i class="fa fa-plus-circle"></i> Agregar
      </button>
      <button class="btn btn-danger text-right" @click="descargar()">
    ...
    <div class="card-body">
      ...
      <el-table :data="procesos" style="width: 100%">
        <div slot="empty">
          <span
            >No se encontraron resultados <el-icon name="search"></el-icon
          ></span>
        </div>
        <el-table-column label="Socio" prop="nombres"> </el-table-column>
        <el-table-column label="Lugar" prop="lugar"> </el-table-column>
        <el-table-column label="Detalle" prop="detalle"> </el-table-column>
        <el-table-column label="Valor" prop="valor"> </el-table-column>
        <el-table-column label="FechaReg" prop="created_at"> </el-table-column>
        <el-table-column label="Creado por" prop="user"> </el-table-column>
