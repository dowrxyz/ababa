<template>
    ...
    <div class="card-header">
        ...
        <button class="btn btn-danger text-right" @click="regresar()"> Regresar</button>
    </div>
    <div class="card-body">
        <el-row :gutter="20">
            <el-col :span="12" style="margin-bottom: 20px;">
                <el-label>Socio</el-label>
                <el-select class="w-100" v-model="editando.socio.id" placeholder="Socio" :filterable="true">
                    <el-option
            ...
            <el-col :span="8">
                <el-label>Socio</el-label>
                <el-select class="w-100" v-model="editando.lugar" placeholder="Lugar" :filterable="true">
                    <el-option
            ...
            <el-col :span="4">
                ...
                <el-input placeholder="Valor" v-model="editando.valor"></el-input>
            </el-col>
            <el-col :span="24" style="margin-bottom: 20px;">
                <el-label>Detalle</el-label>
                <el-input placeholder="Detalle" v-model="editando.detalle"></el-input>
            </el-col>
            <el-col :span="20">
                .
            </el-col>
            <el-col :span="4">
                <el-button type="primary" style="width: 100%" @click="newRegistro">Guardar</el-button>
            </el-col>
        </el-row>
    </div>
  </div>
           ...
           regresar()
           {
            ...
            newRegistro()
            {
                const params = {
                    ...
                    socio: this.editando.socio.id,
                    lugar: this.editando.lugar,
                    valor: this.editando.valor,
                    detalle: this.editando.detalle,
                    id: this.editando.id
                }

                axios.put('/api/procesos', params).then((response) => {
