<template>
    ...
    <el-row :gutter="20">
        <el-col :span="8">
           ...
           <el-select class="w-100" :disabled="true" v-model="editando.socio" placeholder="Socio" :filterable="true">
            <el-option
        ...
        <el-col :span="8">
           ...
           <el-select class="w-100" :disabled="true" v-model="editando.tipo_pago.id" placeholder="Tipo de Pago" :filterable="true">
            <el-option
                v-for="item in tipos"
                :key="item.id"
                :label="item.nombre"
        ...
        <el-col :span="8">
           ...
           <el-select class="w-100" :disabled="true" v-model="editando.banco" placeholder="Banco" :filterable="true">
            <el-option
    ...
    <el-row :gutter="20">
        <el-col :span="8">
           ...
           <el-input v-model="editando.cuenta" :disabled="true" placeholder="Numero"> </el-input>
        </el-col>

        <el-col :span="4">
            <el-label>Total</el-label>
           <el-input v-model="editando.total" :disabled="true" placeholder="Total"> </el-input>
        </el-col>
...
export default {
    ...
    methods: {
        newRegistro()
        {
                ...
                axios.post('/api/update-estado-aporte', params).then((response) => {
                    ...
                    this.$emit('regresarListado', id_socio, nombres);
                })
        },
        regresar()
        {
