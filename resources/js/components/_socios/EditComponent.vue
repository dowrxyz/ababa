    ...
    <el-tabs type="border-card">
        ...
        <el-tab-pane label="Datos del Socio">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="6">
                    <el-input
                        v-model="editando.telefono"
                        placeholder="Telefono"
                    >
                    </el-input>
                </el-col>
                <el-col :span="6">
                    <el-input v-model="editando.movil" placeholder="Movil">
                    </el-input>
                </el-col>
            </el-row>
            ...
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-input v-model="editando.correo" placeholder="Correo">
                    </el-input>
                </el-col>
        ...
        <el-tab-pane label="Datos del Contacto de Emergencia">
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-input
                        v-model="editando.nombres_referencia"
                        placeholder="Nombre"
                    >
                    </el-input>
                </el-col>
                <el-col :span="12">
                    <el-input
                        v-model="editando.movil_referencia"
                        placeholder="Movil"
                    >
                    </el-input>
                </el-col>
        ...
        <el-tab-pane label="Informacion Financiera">
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-input v-model="editando.cuenta" placeholder="Cuenta">
                    </el-input>
                </el-col>
                <el-col :span="12">
                    <el-select
