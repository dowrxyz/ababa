<template>
    <div class="card">
        ...
        <el-table :data="socios" stripe style="width: 100%">
                    ...
                    >
                        ...
                        <el-col :span="4">
                            <el-button
                                ...
                                type="primary"
                                @click="
                                    dsecargarArchivo(props.row.ficha_pdf.url)
                                "
                            >
                                <i class="fa fa-user"></i> Ficha Del
                                Usuario</el-button
                            >
                        </el-col>
                        <el-col :span="4">
                        ...
                        <el-col :span="5" style="margin-top: 10px">
                            <el-button
                                ...
                                "
                            >
                                <i class="fa fa-file-pdf"></i> Actualización De
                                Datos</el-button
                            >
                        </el-col>
                        <el-col :span="4" style="margin-top: 10px">
                            <el-button
                                ...
                                "
                            >
                                <i class="fa fa-file-pdf"></i> Descuento Del
                                ISSFA</el-button
                            >
                        </el-col>
                    </el-row>
            ...
            <el-table-column prop="banco.siglas" label="Banco">
            </el-table-column>
