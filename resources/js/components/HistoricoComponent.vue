...
export default {
    ...
    mounted() {
        axios.get("/historico/listado").then((response) => {
    ...
    methods: {
        ...
        updateList(page) {
            axios.get("/historico/listado?page=" + page).then((response) => {
                this.socios = response.data.socio.data;
                this.pagination = response.data.pagination;
            });
        },
        ...
        search(page, params) {
            ...
            if (
                ...
                axios
                    .post("/historico/buscar?page=" + page, params)
                    .then((response) => {
                        this.socios = response.data.socio.data;
                        this.pagination = response.data.pagination;
        ...
        listAportes(id_socio, nombres) {
            ...
            axios
                .get("/api/get-aportes-socios/" + id_socio)
                .then((response) => {
