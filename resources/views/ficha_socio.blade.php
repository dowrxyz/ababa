<img src="logo.png" width="50%" style="margin-left: 10%" alt="">
...
<table style="width: 100%;font-size: 15px;">
    ...
    <tr style="width: 100%">
        ...
        <td style="width: 50%"> <b> {{ $socio->estado["value"] }} /
...
<p style="text-align: justify;font-size: 15px;">
    ...
    <b>{{ $socio->banco["nombre"] }}</b> .la cantidad de 5 dólares mensuales,
    10 dólares
    bimensuales, 30 dólares semestrales, y / o 60 dólares anuales, más costos
    bancarios. De igual forma me comprometo a mantener los fondos suficientes en
    mi cuenta de ahorros
    a fin de cubrir los valores cuyo debito autorizo a través de este
    instrumento, valores que me obligoa pagar y autorizo debitar de mi cuenta
    ahorros antes
    referida, durante el tiempo que subsista la Asociación de Militares Nueva
    Visión F.A. Además, EXIMO al Banco y/o Cooperativa de toda responsabilidad
    por los descuentos que efectúe
    la Asociación de Militares Nueva Visión F.A. en virtud de la presente
    autorización de debito, por lo que renuncio a presentar por este concepto,
    cualquier
    acción judicial o extrajudicial en contra del Banco y/o Cooperativa. En todo
    caso voluntariamente puedo realizar abonos proporcionales mensuales,
    bimensuales,
    semestrales o anuales, valores que depositaré a la cuenta de ahorros de la
...
<table style="width: 100%;font-size: 15px;">
    ...
    <tr style="width: 100%">
        <td style="width: 50%"> <b> Nombre Referencia: </b> </td>
        <td style="width: 100%"> <b> {{ $socio->nombres_referencia }} </b>
        </td>
        <td style="width: 50%"> </td>
    </tr>
    <tr style="width: 100%">
